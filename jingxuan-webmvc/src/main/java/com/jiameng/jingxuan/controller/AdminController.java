...
public class AdminController {
	...
	public JSONObject deleteCategory(@RequestBody JSONObject deleteCategory) {
		...
		if (!flag) {
			result.put(MSG, "删除产品类目失败，请重试！");
			result.put(CODE, UPDATE_ERROE);
			result.put(DATA, null);
			return result;
		}
		result.put(MSG, "success");
